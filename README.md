# APL v1.0 – Arduino Peripheral Library
...
| --- | --- | --- | --- |
| 16 MHz (Uno/Nano) | 11 | 8 | 64x160 |
| 24 MHz | 21 | 16 | 128x160 |
| 32 MHz (experimental) | 31 |  23 | 184x160 |
...
3. Open the demo application "Font" or "Pong" with Arduino IDE
4. (if required) in APLcore.h change the sys clock and Pixel_Mux definition:
